val records = 1000000
val runID = "20260911-041601"
val base = CoreJob(
  dbname = "de.unihamburg.informatik.nosqlmark.db.RedisClusterClient",
  dbproperties = Map(
    "redis.seeds" -> "redis-20260911-041601-0.redis-20260911-041601-headless.foxtrot-rebalance-20260911-041601.svc.cluster.local:6379,redis-20260911-041601-1.redis-20260911-041601-headless.foxtrot-rebalance-20260911-041601.svc.cluster.local:6379",
    "redis.pool.max" -> "100"
  ),
